  ...
  export const experiences = [
    {
      ...
      desc: "Working on partner document tool as a full stack developer to provide the end to end solution to MySchnider web Partner section",
      skills: [
        "Node Js",
        "Svelte",
        "React JS",
        "AWS: CLI, CDK, Lambda, API Gateway, Dynamodb, Code Pipeline, Cloud Watch",
        "GIT & Github",
        "JavaScript",
        "Typscript"
      ],
    ...
    
    {
      ...
      desc: "Full Stack Developer : CBT- Common Boarding Tool- 2021-2022. Sr.FrontEnd Developer: IRT: IBM Registration tool- 2022 -2023",
      skills: [
        "Node Js",
        "React JS",
        "Carbon Design",
